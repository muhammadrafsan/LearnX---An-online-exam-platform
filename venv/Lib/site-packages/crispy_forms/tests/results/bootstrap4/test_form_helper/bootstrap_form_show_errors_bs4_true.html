    ...
    <div id="div_id_first_name" class="form-group">
        ...
        <div class="">
            <div class="input-group">
                ...
                <input type="text" name="first_name" value="first_name_too_long" maxlength="5" class="textinput textInput inputtext form-control is-invalid" required id="id_first_name" />
